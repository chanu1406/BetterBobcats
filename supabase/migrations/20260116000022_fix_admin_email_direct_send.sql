-- Migration: Fix admin email to send directly (like officers)
-- Admin emails were relying on trigger which wasn't firing reliably
-- Now admin emails are sent directly to email_outbox, same as officers
