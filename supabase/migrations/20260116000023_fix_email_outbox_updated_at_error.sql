-- Migration: Fix email_outbox updated_at error
-- The email_outbox table doesn't have an updated_at column
-- Change ON CONFLICT DO UPDATE SET updated_at to DO NOTHING
...
BEGIN
  ...
  -- FIXED: Use DO NOTHING instead of DO UPDATE SET updated_at (column doesn't exist)
