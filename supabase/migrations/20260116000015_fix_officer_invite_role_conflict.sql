-- Migration: Fix officer invite role conflict
-- If an invite already exists for an email, update the role instead of skipping
-- This prevents officer invites from being created as 'admin' when a conflict occurs
