-- Migration: Add error handling and logging to officer email enqueueing
-- This will help us debug if emails aren't being created
...
BEGIN
  ...
  LOOP
    ...
    -- Use EXACT same payload as contact emails (no role field)
    -- The role field might be causing Resend to reject it
    v_payload := jsonb_build_object(
      ...
      -- Removed 'role' field - use exact same payload as contact emails
    );
