...
,
  ...
  "description": "Concepts and tools for continuous- and discrete-time signal and system analysis with applications in signal processing, communications, and control. Mathematical foundations for analyzing power system transients, harmonics, and stability in modern electrical grids.",
  "tier": 2,
  "expandedInfo": {
    "credits": 4,
    "careerRelevance": "Signal processing forms the analytical core for modern power systems engineering, enabling engineers to detect and classify power quality disturbances, analyze grid stability margins, and design control algorithms for renewable energy integration. As California's grid transitions to 70% renewable sources by 2030, the ability to process and interpret high-frequency voltage/current signals from inverter-based resources becomes critical for preventing cascade failures and maintaining grid reliability. This course provides the mathematical framework (Fourier analysis, Laplace transforms, state-space models) that underpins all digital protection relays, phasor measurement units (PMUs), and energy management systems deployed in contemporary power infrastructure.",
    "realWorldApplications": [
      "Power Quality Disturbance Classification: Applying Short-Time Fourier Transforms (STFT) and wavelet analysis to detect voltage sags, swells, and harmonic distortions caused by non-linear loads such as EV chargers and solar inverters, enabling utilities to assess compliance with IEEE 519 standards.",
      "Fault Detection and Location: Using high-pass filtering and transient signal analysis to identify high-impedance faults and insulation breakdown in distribution feeders, processing current waveforms to pinpoint fault location within 30 meters for rapid crew dispatch.",
      "Grid Stability Assessment: Implementing Kalman filters and state-space models to estimate generator rotor angles and detect emerging oscillatory modes in real-time, providing early warning of potential inter-area oscillations that could lead to blackout conditions."
    ],
    "learningOutcomes": [
...
,
  ...
  "description": "Advanced analysis and design of analog integrated circuits with emphasis on MOS and bipolar technologies. Covers active filters, feedback amplifier stability, frequency response, and non-ideal operational amplifier characteristics essential for power electronics interfaces.",
  "tier": 1,
  "expandedInfo": {
    "credits": 4,
    "careerRelevance": "While digital controllers provide the 'brains' of modern power systems, analog circuits form the critical interface between low-voltage control logic and high-power semiconductor devices. This course directly enables the design of gate driver circuits that switch 1200V SiC MOSFETs in solar inverters, precision current-sense amplifiers for battery management systems, and frequency compensation networks that stabilize DC-DC converters under variable renewable generation. The feedback amplifier concepts taught here determine whether a voltage regulator oscillates or provides stable output when PV panels experience cloud transients—making the difference between reliable grid operation and equipment damage.",
    "realWorldApplications": [
      "High-Side Gate Driver Design: Implementing bootstrap circuits and level-shifters using discrete transistors and op-amps to drive N-channel MOSFETs in buck converters for EV battery charging stations, handling 400V bus voltages with isolation requirements exceeding 2.5kV.",
      "Precision Current Sensing: Designing differential instrumentation amplifiers with common-mode rejection ratios >100dB to monitor shunt resistor voltages in the microvolt range, enabling accurate state-of-charge estimation for grid-scale lithium-ion storage systems.",
      "Feedback Loop Compensation: Applying pole-zero compensation techniques and Miller effect analysis to stabilize voltage-mode controlled converters, ensuring phase margins exceed 60 degrees when operating with input voltage ranges from 200V to 600V in solar applications."
    ],
    "learningOutcomes": [
