        ...
        <nav className="space-y-1">
          {degrees.map((degree) => (
            <button
              ...
              className={`w-full text-left px-4 py-3 transition-colors border border-border/50 rounded-md ${
                selectedDegree === degree
                  ? "bg-primary text-primary-foreground font-semibold border-primary shadow-sm"
                  : "hover:bg-primary/10 hover:text-primary hover:border-primary/30 text-foreground bg-card"
              }`}
            >
              {degree}
            </button>
