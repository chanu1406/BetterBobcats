...
export const tier1Courses: TierCourse[] = [
  {
    ...
    expandedInfo: {
      credits: 4,
      prerequisites: "Intro to CS / programming, and data structures",
      learningOutcomes: [
      ...
      topics: [
        ...
        "Concurrency primitives and synchronization (mutexes, semaphores, RCU and other patterns) :contentReference[oaicite:0]{index=0}",
      ...
      resources: {
        videos: [
          "https://www.youtube.com/watch?v=dOiA2nNJpc0", // Intro to OS fundamentals
        ],
        websites: [
      ...
      additionalNotes:
        "Operating systems courses often also cover kernel interfaces, system calls, and practical labs where you build or modify components of an OS kernel — directly supporting roles in systems, cloud, and infrastructure engineering. :contentReference[oaicite:2]{index=2}",
    },
  },
  {
    id: "systems-cse-160",
    ...
    expandedInfo: {
      credits: 4,
      prerequisites: "Intro to CS / programming basics",
      learningOutcomes: [
      ...
      topics: [
        ...
        "Link, network, and transport layers — Ethernet, IP addressing, TCP/UDP behaviors (flow & congestion control) :contentReference[oaicite:3]{index=3}",
        "Routing fundamentals and algorithms (e.g., OSPF principles) :contentReference[oaicite:4]{index=4}",
      ...
      resources: {
        videos: [
          "https://www.youtube.com/watch?v=l2dQ2V8kffY", // TCP/IP fundamentals overview
        ],
        websites: [
      ...
      additionalNotes:
        "Computer networking courses often include hands-on labs and simulations where students configure real or virtual networks, troubleshoot issues, and understand protocols’ behavior under different conditions — directly applicable to real infrastructure work. :contentReference[oaicite:6]{index=6}",
    },
  },
  {
    id: "systems-cse-168",
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "CSE 150 (Operating Systems) and CSE 160 (Computer Networks) recommended",
      ...
      careerRelevance:
        "Distributed Software Systems is one of the most important courses for systems/infrastructure careers — from **distributed systems engineers**, **cloud architects**, and **site reliability engineers** to developers of large-scale backend services. It equips students with the ability to build and reason about services that run across many machines, handle failures gracefully, and scale with load. Companies building distributed services — from cloud platforms to real-time data pipelines — rely on the concepts taught in this class. :contentReference[oaicite:0]{index=0}",
      ...
      resources: {
        videos: [
          "https://www.youtube.com/watch?v=oV9rvDllKEg", // Distributed systems overview (scalability, CAP theorem)
          "https://www.youtube.com/watch?v=E5ktZ0IQQ4o", // Fault tolerance & distributed algorithm intro
        ],
        websites: [
          "https://catalog.ucmerced.edu/preview_course_nopop.php?catoid=24&coid=69743", // Official distributed systems course page :contentReference[oaicite:1]{index=1}
          "https://en.wikipedia.org/wiki/Distributed_computing", // Distributed computing fundamentals :contentReference[oaicite:2]{index=2}
          "https://en.wikipedia.org/wiki/Consistency_model", // Consistency models overview :contentReference[oaicite:3]{index=3}
        ],
        tools: [
      ...
      additionalNotes:
        "According to the UC Merced catalog, CSE 168 covers the foundations of distributed software systems — including consistency, availability, scalability, and core programming models — all of which are central to modern cloud and backend infrastructure engineering. :contentReference[oaicite:4]{index=4}",
    },
  },
  {
    id: "systems-cse-140",
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "CSE 031 (Computer Organization & Assembly) or equivalent low-level systems programming experience recommended",
      ...
      resources: {
        ...
        websites: [
          "https://catalog.ucmerced.edu/preview_course_nopop.php?catoid=24&coid=67529", // Official UC Merced course description :contentReference[oaicite:1]{index=1}
      ...
      additionalNotes:
        "According to the UC Merced catalog, CSE 140 covers fundamental concepts of digital computer design, including instruction sets, memory systems, and register logic — knowledge that is directly applicable when optimizing systems and infrastructure software at scale. :contentReference[oaicite:2]{index=2}",
    },
  },
  {
    id: "systems-cse-179",
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "CSE 100 (Algorithm Design & Analysis) and CSE 030 (Data Structures) recommended",
      ...
      careerRelevance:
        "Parallel Computing equips systems engineers and infrastructure developers with the skills to optimize performance in multi-core and distributed environments — a necessity in cloud computing, high-performance backends, and modern OS runtimes. Understanding how to exploit parallelism and avoid contention is central to building responsive, scalable, and efficient systems. :contentReference[oaicite:0]{index=0}",
      ...
      resources: {
        videos: [
          "https://www.youtube.com/watch?v=6Luyflzhv9g", // Parallel & distributed computing intro
        ],
        websites: [
      ...
      additionalNotes:
        "According to UC Merced’s catalog, CSE 179 introduces the foundations of parallel computing — including architectures, programming methods, and how to analyze parallel algorithms. Mastery of these concepts is critical for performance-oriented system and infrastructure engineers. :contentReference[oaicite:1]{index=1}",
    },
  },
  {
    id: "systems-cse-031",
    ...
    expandedInfo: {
      credits: 4,
      prerequisites: "Intro programming (C or equivalent)",
      ...
      resources: {
        videos: [
          "https://www.youtube.com/watch?v=Z3bhF0wjk9M", // Intro to assembly & low-level execution
        ],
        websites: [
      ...
      additionalNotes:
        "CSE 031 introduces students to the fundamentals of computer organization and assembly programming — including how binary data is manipulated and how ISA translates logic into hardware actions. This knowledge is critical for efficient systems programming and performance engineering. :contentReference[oaicite:3]{index=3}",
    },
  },
];
...
export const tier2Courses: TierCourse[] = [
  {
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "CSE 031 (Computer Organization & Assembly) and CSE 140 (Computer Architecture) recommended",
      ...
      resources: {
        ...
        websites: [
          "https://catalog.ucmerced.edu/preview_course_nopop.php?catoid=24&coid=69812", // Official UC Merced course page (description) :contentReference[oaicite:1]{index=1}
          "https://en.wikipedia.org/wiki/Microarchitecture", // Microarchitecture fundamentals :contentReference[oaicite:2]{index=2}
...

  {
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "CSE 140 (Computer Architecture) and CSE 031 (Computer Organization & Assembly) or equivalent foundational architecture knowledge",
      ...
      resources: {
        videos: [
          "https://www.youtube.com/watch?v=pMIBcYIEcRo", // Advanced computer architecture course overview
        ],
        websites: [
          "https://catalog.ucmerced.edu/preview_course_nopop.php?catoid=24&coid=69757", // Official UC Merced course description :contentReference[oaicite:1]{index=1}
      ...
      additionalNotes:
        "EECS 242 expands on foundational architecture concepts to explore performance, energy efficiency, and reliability in depth. This prepares students for advanced systems roles where architectural understanding directly influences software and infrastructure design. :contentReference[oaicite:2]{index=2}",
    },
  },
  {
    id: "systems-eecs-245",
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "Foundations in computer architecture and systems programming (e.g., CSE 140, CSE 150) recommended",
      ...
      resources: {
        videos: [
          "https://www.youtube.com/watch?v=oV9rvDllKEg", // Parallel & distributed computing overview
          "https://www.youtube.com/watch?v=ev7z8fXktIA", // Multiprocessor & parallel concepts
        ],
        websites: [
          "https://en.wikipedia.org/wiki/Parallel_computing", // Field overview and core concepts :contentReference[oaicite:1]{index=1}
          "https://en.wikipedia.org/wiki/Message_Passing_Interface", // MPI as core communication for parallel systems :contentReference[oaicite:2]{index=2}
        ],
        tools: [
      ...
      additionalNotes:
        "EECS 245 appears as a graduate-level Parallel Computing course in the UC Merced EECS catalog, supplementing foundational courses like CSE 179 (Intro to Parallel Computing) and focusing on **performance, scalability, and advanced parallel design techniques**. :contentReference[oaicite:3]{index=3}",
    },
  },
  {
    id: "systems-eecs-250",
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "Operating Systems (CSE 150) and Computer Architecture (CSE 140) recommended",
      ...
      resources: {
        ...
        websites: [
          "https://catalog.ucmerced.edu/preview_course_nopop.php?catoid=24&coid=67642", // UC Merced course description (EECS 250) :contentReference[oaicite:1]{index=1}
      ...
      additionalNotes:
        "According to the UC Merced catalog, EECS 250 engages students in advanced topics in computer systems and prepares them to tackle complex infrastructure challenges and current research themes across OS, networking, and distributed systems. :contentReference[oaicite:2]{index=2}",
    },
  },
  {
    id: "systems-eecs-251",
    ...
    expandedInfo: {
      credits: 4,
      prerequisites: "Operating Systems (CSE 150) recommended",
      ...
      careerRelevance:
        "EECS 251 combines *deep OS internals* with applied projects and research exposure, ideal for careers as **Systems Engineer**, **Site Reliability Engineer (SRE)**, **OS Kernel Developer**, or **Infrastructure Security Specialist**. Students gain practical skills in kernel-level engineering and large-scale OS design. :contentReference[oaicite:3]{index=3}",
      ...
      resources: {
        ...
        websites: [
          "https://catalog.ucmerced.edu/preview_course_nopop.php?catoid=24&coid=69552", // UC Merced EECS 251 description :contentReference[oaicite:4]{index=4}
      ...
      additionalNotes:
        "EECS 251 goes beyond basic OS concepts and includes distributed OS topics, security, real-time control, IoT support, and OS research engagement as part of student projects. :contentReference[oaicite:5]{index=5}",
    },
  },
  {
    id: "systems-eecs-263",
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "Operating Systems (CSE 150) and Computer Networks (CSE 160) recommended",
      ...
      topics: [
        "Cloud fundamentals: definitions, characteristics, and service models (IaaS, PaaS, SaaS) :contentReference[oaicite:0]{index=0}",
        "Virtualization and container technologies (VMs, containers) :contentReference[oaicite:1]{index=1}",
        "Cloud architecture patterns and design principles :contentReference[oaicite:2]{index=2}",
        "Cloud networking, load balancing, and distributed services :contentReference[oaicite:3]{index=3}",
        "Cloud storage systems and data persistence :contentReference[oaicite:4]{index=4}",
        "Security, governance, and cost management in cloud environments :contentReference[oaicite:5]{index=5}",
      ],

      careerRelevance:
        "Cloud computing skills are central for systems and infrastructure careers — particularly for **Cloud Engineers**, **DevOps/Platform Engineers**, **Site Reliability Engineers (SRE)**, and **Backend Architects**. Knowledge of cloud architecture, virtualization, automation, and distributed systems allows engineers to build and operate highly scalable infrastructure that supports modern applications. According to UC Merced’s course listings, EECS 263 exists as a core course in the EECS curriculum focused on cloud computing technologies. :contentReference[oaicite:6]{index=6}",
      ...
      resources: {
        ...
        websites: [
          "https://catalog.ucmerced.edu/preview_course_nopop.php?catoid=24&coid=68589", // Official UC Merced course page (EECS 263) :contentReference[oaicite:7]{index=7}
          "https://en.wikipedia.org/wiki/Cloud_computing", // Cloud computing overview fundamentals
          "https://www.coursera.org/learn/cloud-computing", // Cloud computing online course concepts :contentReference[oaicite:8]{index=8}
        ],
        tools: [
      ...
      additionalNotes:
        "EECS 263 focuses on cloud computing principles, virtualization, deployment models, and distributed services that underpin modern infrastructure engineering. Students gain both conceptual understanding and practical skills in building and operating cloud systems. :contentReference[oaicite:9]{index=9}",
    },
  },

  {
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "Distributed Systems fundamentals (e.g., CSE 168) and strong programming background recommended",
      ...
      resources: {
        videos: [
          "https://www.youtube.com/watch?v=43TDfUNsM3E", // Fault tolerance fundamentals in distributed systems :contentReference[oaicite:1]{index=1}
        ...
        websites: [
          "https://catalog.ucmerced.edu/preview_course_nopop.php?catoid=24&coid=69862", // UC Merced EECS 266 course description :contentReference[oaicite:2]{index=2}
        ...
        tools: [
          ...
          "SimGrid", // Distributed system simulation and analysis :contentReference[oaicite:3]{index=3}
          "Docker & Kubernetes", // Container orchestration for distributed workloads
        ],
      },

      additionalNotes:
        "EECS 266 provides an advanced foundation in building distributed systems that handle real-world challenges such as partial failures, network partitions, and consistency trade-offs. Students practice designing, implementing, and evaluating systems that balance availability, reliability, and performance — core competencies for distributed infrastructure engineering. :contentReference[oaicite:4]{index=4}",
    },
  },
  {
    id: "systems-eecs-268",
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "Distributed Systems (e.g., CSE 168) and Parallel/Systems fundamentals recommended",
      ...
      resources: {
        ...
        websites: [
          "https://catalog.ucmerced.edu/preview_course_nopop.php?catoid=24&coid=69769", // Official UC Merced EECS 268 course description :contentReference[oaicite:2]{index=2}
          "https://en.wikipedia.org/wiki/Hyperscale_computing", // Hyperscale computing context :contentReference[oaicite:3]{index=3}
          "https://en.wikipedia.org/wiki/Server_farm", // Server farms & datacenter basics :contentReference[oaicite:4]{index=4}
        ],
        tools: [
      ...
      additionalNotes:
        "EECS 268 focuses on *hardware plus systems software research* for warehouse-scale computing and advanced infrastructure design, including virtualization, networking, storage, and performance analysis. Students often read and present research as part of the course. :contentReference[oaicite:5]{index=5}",
    },
  },
  {
    id: "systems-eecs-280",
    ...
    expandedInfo: {
      credits: 3,
      prerequisites:
        "Basic Computer Networks (e.g., TCP/IP stack, socket programming) and Operating Systems or Distributed Systems fundamentals recommended",
      ...
      resources: {
        videos: [
          ...
          "https://www.youtube.com/watch?v=eXHz5s6K9jM",
        ],
        websites: [
...
export const tier3Courses: TierCourse[] = [
  ...
  // I'll create unique advanced courses based on the pattern
  {
    ...
    expandedInfo: {
      credits: 3,
      prerequisites:
        "Operating Systems + Systems Programming (C/C++/Go); basic networking and statistics helpful",
  ...
  },
  {
    ...
    expandedInfo: {
      credits: 3,
      prerequisites:
        "Data Structures + Databases + Networking basics; familiarity with distributed systems concepts recommended",
...
export const tier4Courses: TierCourse[] = [
  ...
  },
  {
    ...
    expandedInfo: {
      credits: 4,
      prerequisites: "MATH 024 and (ME 140 or EE 102)",
  ...
  },
  {
    ...
    expandedInfo: {
      credits: 4,
      prerequisites: "ME 140 or ME 141",
  ...
  },
  {
    ...
    expandedInfo: {
      credits: 4,
      prerequisites: "(MATH 023 or MATH 023H) and MATH 024",
...

  {
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "ME 140 (Vibrations & Control Systems) OR ME 141 (Control Systems) OR EE 145 (Signal Processing & Linear Systems) — or instructor approval",
  ...
  },
  {
    ...
    expandedInfo: {
      credits: 3,
      prerequisites:
        "ME 141 (Control Engineering / Control Systems) or equivalent; plus EE 102 (Signal Processing & Linear Systems) or equivalent",
...
export const tier5Courses: TierCourse[] = [
  ...
  },
  {
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "Graduate standing; recommended: computer networking fundamentals + probability/stochastic intuition",
  ...
  },
  {
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "Graduate standing; recommended: embedded systems basics + networking fundamentals",
...

  {
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "Graduate standing recommended; helpful background: discrete math/logic, automata, algorithms, and concurrency/distributed systems fundamentals.",
      ...
      careerRelevance:
        "EECS 272 is high-leverage for systems/infra because many production failures are 'logic bugs under concurrency + failure.' " +
        "Verification skills help you define invariants (what must never happen) and prove/validate them early. " +
        "This maps to roles like Infrastructure/Platform Engineer, SRE, Distributed Systems Engineer, and Security Engineering.",
      ...
      additionalNotes:
        "Infra framing: focus on invariants and failure-mode reasoning (timeouts, retries, partitions, partial failures). " +
        "Even lightweight modeling/specs can prevent expensive production incidents.",
    },
  },
  {
    id: "systems-math-140",
    ...
    expandedInfo: {
      credits: 4,
      prerequisites:
        "(MATH 023 or MATH 023H) and MATH 024 and (CSE 021 or ME 021 or equivalent exam). " +
        "Concurrent prerequisite: MATH 130 or MATH 131.",
      ...
      careerRelevance:
        "Optimization is everywhere in infrastructure: schedulers, traffic engineering, autoscaling, admission control, " +
        "capacity planning, and cloud cost optimization. Engineers who can model objectives/constraints can justify decisions " +
        "with math and ship better systems in Infra/Platform, SRE, Performance Engineering, and ML/Systems roles.",
      ...
      additionalNotes:
        "Infra rule of thumb: define objective + constraints first (SLOs, budgets, fairness, reliability). " +
        "Once the model is clear, you can swap solvers/approaches as needed.",
    },
  },
];
